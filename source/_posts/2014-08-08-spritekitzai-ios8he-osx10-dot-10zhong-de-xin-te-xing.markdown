...
![](http://yulingtianxia.qiniudn.com/140738700571.png)  
...
![](http://yulingtianxia.qiniudn.com/140738949518.png)
...
![](http://yulingtianxia.qiniudn.com/140740041011.png)  

而Per-Pixel Physics根据纹理图片的alpha通道遮罩来生成一个粗略的形状，然后再用粗略的形状生成精确的形状，它让以前复杂的`CGPath`创建工作转变成一行代码：  

![](http://yulingtianxia.qiniudn.com/140740040721.png)  
...
![](http://yulingtianxia.qiniudn.com/140740456021.png)  
...
![](http://yulingtianxia.qiniudn.com/140741648388.gif)  
...
![](http://yulingtianxia.qiniudn.com/update_loop_2x.png)  
...
![](http://yulingtianxia.qiniudn.com/14074923846.png)  
...
- `SKPhysicsBody`允许用`bodyWithBodies:`把多个物理体组合在一起来创建一个新的物理体，还记得前面提到过的斧头么：  
	![](http://yulingtianxia.qiniudn.com/140749497219.png)   
