...
下面我们将自定义`NSManagedObject`类，通过对它的继承拓展，使得我们有自己的Event类，并通过访问http://yulingtianxia.qiniudn.com/器方法代替KVC方式来访问对象的属性。  
按CMD+N或者在可视化建模工具下选择菜单中Editor->Create NSManagedObject Subclass：  

![](http://yulingtianxia.qiniudn.com/140353399425.png)  

![](http://yulingtianxia.qiniudn.com/140353399917.png)  

选中需要子类化的Entity（当然我们只有一个Event，自动勾选了）：  

![](http://yulingtianxia.qiniudn.com/140353400261.png)  
...
![](http://yulingtianxia.qiniudn.com/140353400282.png)  
...
![](http://yulingtianxia.qiniudn.com/140353400755.png)  

![](http://yulingtianxia.qiniudn.com/140353401739.png)  

点击右下方的Editor Style切换到Graph模式：  

![](http://yulingtianxia.qiniudn.com/140353401953.png)  
...
![](http://yulingtianxia.qiniudn.com/140353402308.png)  

![](http://yulingtianxia.qiniudn.com/14035340227.png)  

我们再尝试一种添加关系的新方法：把以前在Teacher中建立的students删除，选中Student，按住Ctrl，鼠标拖至Teacher，这样一个双向的关系就建立起来了：  

![](http://yulingtianxia.qiniudn.com/140353402879.png)  

分别编辑双方的关系，Tpye都是To Many：  

![](http://yulingtianxia.qiniudn.com/140353402596.png)  

用上一节中提到的方法，建立这三个新建的Entity的`NSManagedObject`子类：  

![](http://yulingtianxia.qiniudn.com/14035340286.png)  
...
![](http://yulingtianxia.qiniudn.com/140353403195.png)  
...
![](http://yulingtianxia.qiniudn.com/140353403982.png)  

你会发现虽然Student和Teacher继承Person，但是Person表里面竟然也有grade和course字段

点击程序中的加号来添加一条数据：  

![](http://yulingtianxia.qiniudn.com/140353403912.png)  

查看ZPERSON，Z_3TEACHERS，Z_PRIMARYKEY表内容：  

![](http://yulingtianxia.qiniudn.com/140353404264.png)  

![](http://yulingtianxia.qiniudn.com/140353404745.png)  

![](http://yulingtianxia.qiniudn.com/140353405697.png)  
